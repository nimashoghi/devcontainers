...
docker push $DOCKER_USERNAME/fsharp:netcoreapp2.2-latest-$TRAVIS_TAG
docker push $DOCKER_USERNAME/fsharp:netcoreapp2.2-latest
...
docker push $DOCKER_USERNAME/node:current-latest-$TRAVIS_TAG
docker push $DOCKER_USERNAME/node:current-latest
...
docker push $DOCKER_USERNAME/node:lts-latest-$TRAVIS_TAG
docker push $DOCKER_USERNAME/node:lts-latest
...
docker push $DOCKER_USERNAME/python:2.7-latest-$TRAVIS_TAG
docker push $DOCKER_USERNAME/python:2.7-latest
...
docker push $DOCKER_USERNAME/python:3.7-latest-$TRAVIS_TAG
docker push $DOCKER_USERNAME/python:3.7-latest
